...
%\caption{Horospherically truncated pair of pants, with active domain relative to a repulsion cost (Def.\ref{cost1} from \S \ref{repc}). Halfspace Conditions fail. $P \leadsto Z_1 \leadsto Z_2$ are homotopy equivalent, where $P$ is pair of pants. But $Z_2$ does not deformation retract to $Z_3$}
%\end{figure}
